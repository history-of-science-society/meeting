    ...
    >
      ...
      <section class="detail" :class="{ show: state }">
        ...
        <div class="presenters">
          ...
          <presenter-section
            num="9"
            :author="node.author9Name"
            :institution="node.author9InstitutionalAffiliation"
            :title="node.abstract9Title"
            :coauthor="node.coAuthor9Name"
            :coinstitution="node.coAuthor9InstitutionalAffiliation"
          />
        </div>
      </section>
    </article>
